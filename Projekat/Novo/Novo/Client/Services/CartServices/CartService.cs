...
using Novo.Client.Services.ImplementationServices;
using Novo.Client.Services.InterfaceServices;
...
namespace Novo.Client.Services.CartServices
{
    public class CartService : ICartService
    {
        ...
        public CartService(ILocalStorageService localStorageService, IJSRuntime jSRuntime, IProductServices productServices)
        {
        ...
        public async Task<List<CartModel>> GetCart()
        {
            ...
            if (MyCart != null)
            {
                ...
                {
                    var product = await productServices.GetProduct(item.ProductId);
                    if (product != null)
                    {
